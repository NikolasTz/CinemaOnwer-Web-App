<?php
	...
	// Access only if has been initialized the role and only if has been selected to delete movie from favorites table
	if( (!isset($_SESSION['role'])) or strcmp($_SESSION['role'],'USER') !== 0 or (!isset($_REQUEST['favid'])) ){
	...
	curl_setopt_array($curl, array(
		CURLOPT_URL => 'http://172.18.1.10:1027/api/favorites/'.$_REQUEST['favid'],
	...
	if (strcmp($httpcode,'200') == 0) { $print_message = "Movie deleted successfully from Favorites"; }
