<?php
	...
	// Access only if has been initialized the role and only if has been selected to move to the favorites_movies page
	if( (!isset($_SESSION['role'])) or strcmp($_SESSION['role'],'USER') !== 0 or (!isset($_REQUEST['favorites'])) ){
			...
			$str = $str."<li class=\"collection-item avatar\">
				<i class=\"material-icons circle teal \">movie</i>".
					...
					<div class=\"secondary-content\">
						<button onclick=\"deleteFavorite('$rows[_id]')\" class=\"btn waves-effect waves-light\">
